	...
	<ul style="margin:16px;" id="job-list">
		...
		<li>
			<div class="row" style="margin-bottom: 20px">
				...
				<div class="span3 text-right" style="font-size:12px;">收藏时间：<?php echo date('Y-m-d H:i:s', $row['insertTime']->sec);?></div>
			</div>
			<p class="job-info">
			...
			<p class="job-info text-right"><a href="<?php $this->url('content/collect/delete', 'id=' . $row['_id'])?>">删除</a></p>
		</li>
		<?php endforeach;?>
	</ul>
