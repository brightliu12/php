<?php
/*
 * 调用人人网RESTful API的客户端类，本类需要继承RESTClient类方可使用 要求最低的PHP版本是5.2.0，并且还要支持以下库：cURL, Libxml 2.6.0 This class for invoke RenRen RESTful Webservice It MUST be extends RESTClient The requirement of PHP version is 5.2.0 or above, and support as below: cURL, Libxml 2.6.0 @Modified by mike on 17:54 2011/12/21. @Modified by Edison tsai on 14:41 2011/01/13 for wrap call_id & session_key in this class. @Version: 0.0.5 alpha @Created: 17:09:40 2010/11/23 @Author:	Edison tsai<dnsing@gmail.com> @Blog:	http://www.timescode.com @Link:	http://www.dianboom.com
 */
namespace OpenApi\renrenSdk;
...
class RenrenRestApiService extends HttpRequestService {
	...
	public function __construct($APIKey = NULL, $SecretKey = NULL) {
		...
		if ($APIKey && $SecretKey) {
			...
			$config->APIKey = $APIKey; // 你的API Key，请自行申请
			$config->SecretKey = $SecretKey; // 你的API 密钥
